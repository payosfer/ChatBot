...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("ChatBot") == null)
        {
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Angular Client
        var consoleAndAngularClientId = configurationSection["ChatBot_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["ChatBot_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["ChatBot_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["ChatBot_Swagger:RootUrl"].TrimEnd('/');
