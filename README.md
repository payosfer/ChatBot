...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 906ac1d7-6168-454e-b06f-3b8db7a6adee
```

> `906ac1d7-6168-454e-b06f-3b8db7a6adee` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the [ChatBot](./ChatBot) project directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disable it.
